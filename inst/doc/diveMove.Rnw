% $Id: diveMove.Rnw 331 2010-07-20 03:57:20Z sluque $
...
using depth bounds helps to stabilize the surface signal.

<<eval=FALSE>>=
dcalib <- calibrateDepth(tdrX, zoc.method="filter",
...
<<zoc>>=
dcalib <- calibrateDepth(tdrX, zoc.method="offset", offset=3, wet.thr=70,
                         dry.thr=3610, dive.thr=4, descent.crit.q=0.1,
