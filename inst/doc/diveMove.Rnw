% $Id: diveMove.Rnw 521 2012-03-12 15:41:10Z sluque $
...
\SweaveOpts{eps=FALSE, strip.white=all, pdf=FALSE, png=TRUE, resolution=100}
...
<<dives-con>>=
fp <- file.path("data", "dives.csv.gz")
sfp <- system.file(fp, package="diveMove")
ff <- gzfile(sfp, open="r")
<<readin-csv>>=
...
<<dives-con>>
tdrX <- readTDR(ff, speed=TRUE, sep=";", 
