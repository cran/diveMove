...
\Rmethod{getTime}, \Rmethod{getDepth}, \Rmethod{getVeloc}, and
...
\Rmethod{getVelCoefs}.  These are all generic functions\footnote{A few of
  them with more than one method} that access the (depth) calibrated
...
\begin{itemize}
\item [\Rmethod{getTDR}] This method simply takes the \Rclass{TDRcalibrate}
...
\item [\Rmethod{getGAct}] There are two methods for this generic,
